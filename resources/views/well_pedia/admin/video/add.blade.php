    ...
    <main>
        <section>
            <div class="section_container container_left_helper container_right_helper">
                ...
                <form action="{{ route('registerVideo') }}" method="post" class="" id="form_data">
                    @csrf
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group w_200">
                                            <input type="text" class="form-control form_control_600 h_40" name="video_title" value="{{ old('video_title') }}" style="{{ $errors->has('video_title') ? 'border : 1px solid #D9214E!important;' : '' }}" >
                                        </div>
                                        ...
                                        <div class="csv_content_wrapper">
                                            <div class="csv_upload_wrapper d-flex align-items-center flex-wrap">
                                                ...
                                                <div class="uploader">
                                                    ...
                                                    <input type="hidden" name="video_url" id="video-url" value="{{ old('video_url') }}">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="form-group w_70 text-center d-flex align-items-center">
                                                <input type="text" class="form-control text-center h_40" name="point" value="{{ old('point') }}" style="{{ $errors->has('point') ? 'border : 1px solid #D9214E!important' : '' }}">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control textarea_height" name="caption" style="{{ $errors->has('caption') ? 'border : 1px solid #D9214E!important;' : '' }}">{{ old('caption') }}</textarea>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <div class="form_control_action text-center">
                        <button class="btn_dark btn_orange btn_mt_4  content_mb border-0" type="submit" id="submit">
                            登録する
                        </button>
                    </div>
                </form>
