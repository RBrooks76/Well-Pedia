                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input type="text" class="form-control h_40" name="title" value="{{ old('title') }}" style="{{ $errors->has('title') ? 'border : 1px solid #D9214E!important;' : '' }}">
                                        </div>
                                        @if($errors->has('title'))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        <div class="form-group">
                                            <textarea class="form-control textarea_height" name="content" style="{{ $errors->has('content') ? 'border : 1px solid #D9214E!important;' : '' }}">{!! old('content') !!}</textarea>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
